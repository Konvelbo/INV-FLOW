...
export default function AIAdvisorLoading() {
  return (
    <div className="min-h-screen min-w-full bg-background/50 p-6 md:p-10 lg:p-12 pt-32 md:pt-32 lg:pt-32 animate-in fade-in duration-500">
      <div className="max-w-8xl mx-auto space-y-12 h-full flex flex-col">
        {/* Header Skeleton */}
