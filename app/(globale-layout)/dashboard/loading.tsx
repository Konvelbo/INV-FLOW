...
export default function DashboardLoading() {
  return (
    <div className="min-h-full min-w-full bg-background text-foreground p-6 md:p-10 lg:p-12 pt-28 md:pt-28 lg:pt-28 space-y-12 animate-in fade-in duration-500">
      {/* Header Skeleton */}
